...
export const metadata: Metadata = {
  ...
  description:
    "Terms of sale, return policy, and legal notices for Colorado Couch Farm.",
};
  ...
  return (
    <div>
      ...
      <section style={{ background: "var(--ccf-navy)", color: "#fff", padding: "3.5rem 0" }}>
        <div className="nb-container" style={{ maxWidth: "48rem" }}>
          <h1 className="nb-display" style={{ color: "#fff", marginBottom: "0.25rem" }}>Terms &amp; Policies</h1>
          <p style={{ opacity: 0.7, fontSize: "0.875rem" }}>Effective Date: {effectiveDate}</p>
        </div>
      </section>

      <div className="nb-container" style={{ maxWidth: "48rem", padding: "2.5rem 1.5rem" }}>
        {/* Intro */}
        <div className="nb-card--static" style={{ padding: "1.5rem", marginBottom: "2rem" }}>
          <p style={{ color: "var(--nb-gray)", lineHeight: 1.7, fontSize: "0.9375rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <PolicySection num={1} title="All Sales Final">
            <p>
              <strong>
          ...
          <PolicySection num={2} title="As-Is Condition">
            <p>
              All items are sold{" "}
              <strong>&ldquo;as-is, where-is&rdquo;</strong>{" "}
          ...
          <PolicySection num={3} title="Pricing &amp; Payment">
            <p>
          ...
          <PolicySection num={4} title="Pickup &amp; Delivery">
            <p>
          ...
          <PolicySection num={5} title="Limitation of Liability">
            <p>
          ...
          <PolicySection num={6} title="Dispute Resolution &amp; Binding Arbitration" highlight>
            <p>
              <strong>
          ...
          <PolicySection num={7} title="Governing Law &amp; Jurisdiction">
            <p>
          ...
          <PolicySection num={8} title="Indemnification">
            <p>
          ...
          <PolicySection num={9} title="Modifications to Terms">
            <p>
          ...
          <PolicySection num={10} title="Severability">
            <p>
          ...
          <PolicySection num={11} title="Entire Agreement">
            <p>
          ...
          <div className="nb-card--static" style={{ background: "var(--ccf-sunny)", padding: "1.5rem" }}>
            <h2 className="nb-heading" style={{ fontSize: "1.125rem", marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <p style={{ fontSize: "0.875rem", lineHeight: 1.7 }}>
              ...
              contact us at{" "}
              <a href={`mailto:${siteConfig.email}`} style={{ fontWeight: 700, textDecoration: "underline", textUnderlineOffset: "3px" }}>
                {siteConfig.email}
              </a>{" "}
        ...
        <div style={{ marginTop: "2.5rem", textAlign: "center" }}>
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.875rem", color: "var(--nb-gray)", textDecoration: "none", fontWeight: 700 }}>
...
function PolicySection({ num, title, highlight, children }: { num: number; title: string; highlight?: boolean; children: React.ReactNode }) {
  return (
    <section
      className="nb-card--static"
      style={{
        padding: "1.5rem",
        ...(highlight ? { borderWidth: "3px", borderColor: "var(--ccf-cyan)" } : {}),
      }}
    >
      <h2 className="nb-heading" style={{ fontSize: "1.125rem", marginBottom: "0.75rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
        <span className="nb-step-number">{num}</span>
        {title}
      </h2>
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", color: "var(--nb-gray)", fontSize: "0.875rem", lineHeight: 1.7 }}>
        {children}
      </div>
    </section>
  );
